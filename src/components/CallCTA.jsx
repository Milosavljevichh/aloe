...
export default function CallCTA() {
  return (
    <Button className="gap-0 rounded-full py-0 ps-0 text-md flex items-center uppercase font-light font-text bg-primary-orange hover:bg-primary-orange border-2 border-solid border-primary-orange  transition duration-500 hover:cursor-pointer shadow-md">
