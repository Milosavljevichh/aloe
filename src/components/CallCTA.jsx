...
export default function CallCTA({bg="bg-primary-orange", arrow=1, border="border-1 shadow-lg"}) {
  return (
    <Button className={"gap-0 rounded-full py-0 ps-0 text-lg flex items-center uppercase font-light font-text hover:bg-primary-orange border-solid border-primary-orange  transition duration-500 hover:cursor-pointer " + bg + " " + border}>
