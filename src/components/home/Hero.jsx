    ...
    return (
        ...
        ">
            ...
            <div className="relative h-full w-full max-w-6xl mx-auto flex flex-col items-start justify-center text-[#F8F8FF] z-1">
                <h1 className="text-6xl mb-2 font-medium">Lorem ipsum</h1>
                <h1 className="text-6xl mb-5 font-medium">dolor sit amet tempo</h1>
                <h2 className="text-2xl mb-6 max-w-[40%] opacity-90 font-light">Lorem ipsum dolor sit amet, consectetur adipiscing elit</h2>
