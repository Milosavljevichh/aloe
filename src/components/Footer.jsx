...
export default function Footer() {
    return (
        <footer className="bg-primary-grey text-primary-white py-14 mt-16">
            ...
            <div className="flex flex-col lg:flex-row max-w-6xl px-4 mx-auto justify-between gap-10">
                ...
                <div className="max-wnone lg:max-w-1/2 w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-3 pt-4">

                    {/* Navigation links */}
                    <div className="mx-auto lg:mx-0 order-3 lg:order-none">
                        <h4 className="w-full font-header font-semibold text-lg mb-4 text-center lg:text-left">Navigacija</h4>
                        <NavigationMenu className="w-fit lg:w-full max-w-none lg:max-w-fit">
                            <NavigationMenuList className="w-fit lg:w-full gap-2 flex flex-row lg:flex-col items-start">
                                {navigationLinks.map((link, index) => (
                                    <NavigationMenuItem key={index}>
                                        <NavigationMenuLink
                                            href={link.href}
                                            className=" p-0 text-center lg:text-left text-primary-white hover:text-primary-orange hover:bg-transparent py-1.5 font-medium">
                                            {link.label}
                                        </NavigationMenuLink>
                                    </NavigationMenuItem>
                                ))}
                    ...
                    {/* Contact info */}
                    <div className="mx-auto lg:mx-0 order-1 lg:order-none">
                        <div className="mx-auto">
                            <h4 className="font-header font-semibold text-lg mb-4 text-center lg:text-left">Kontakt</h4>
                    ...
                    {/* Social icons */}
                    <div className="mx-auto lg:mx-0 order-2 lg:order-none">
