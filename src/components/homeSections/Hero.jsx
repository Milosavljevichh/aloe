...
export default function Hero() {
    ...
    return (
        <section className="
            ...
            md:bg-[url(/aloe_product_cropped.png)]
            bg-cover
            bg-bottom
            bg-fixed
        ">
            ...
            <div className="relative h-full w-full max-w-6xl mx-auto flex flex-col items-start justify-center text-[#F8F8FF] z-1">
                <h1 className="text-4xl md:text-6xl text-center md:text-left w-full mb-2 font-medium font-header">Tvoje telo zna</h1>
                <h1 className="text-4xl md:text-6xl text-center md:text-left w-full mb-5 font-medium font-header">da priroda leči</h1>
                <h2 className="text-xl md:text-2xl text-center md:text-left w-full mb-6 mx-auto md:mx-0 max-w-[85%] md:max-w-[40%] opacity-90 font-light font-text">Aloe Vera nega koja postaje deo vaše rutine — nežna, čista, efikasna.</h2>
                <div className="flex items-center justify-center gap-2 md:gap-4 mx-auto md:mx-0">
